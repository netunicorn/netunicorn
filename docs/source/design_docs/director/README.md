...
Core services are services that maintain the system itself and provide system capabilities to users via [Frontend](../frontend/README.md) and nodes (see [Target infrastructure](../target/README.md)).
